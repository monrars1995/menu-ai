...
| `OPENROUTER_API_KEY` | Chave em [openrouter.ai/settings/keys](https://openrouter.ai/settings/keys); LiteLLM usa modelos `openrouter/...`. Sem esta chave, a geração falha ao iniciar o worker. |
