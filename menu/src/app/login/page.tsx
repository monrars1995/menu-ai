    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-canvas px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-display font-semibold text-ink">Menu.AI</h1>
        ...
        <div className="rounded-xl border border-hairline/60 bg-white/80 p-6 shadow-lg shadow-black/[0.03] backdrop-blur-sm">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-hairline bg-white px-4 py-2.5 text-sm font-medium text-ink shadow-sm transition-all hover:shadow-md hover:bg-surface-soft"
          >
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white/80 px-2 text-ink-muted-48">ou</span></div>
          </div>
        ...
        <p className="mt-6 text-center text-xs text-ink-muted-48">
          Não tem conta?{" "}
          <a href="/register" className="font-medium text-primary hover:underline">Criar conta</a>
        </p>
      </div>
    </div>
  );
