...
def build_steps(crew) -> List[PipelineStep]:
    ...
    u1 = (
        ...
        "=== SUA TAREFA ===\n"
        f"Leia o contrato do cliente e extraia TODAS as regras de cardápio. {ref_block}\n\n"
        "PASSOS OBRIGATÓRIOS — execute TODOS na ordem:\n"
        "1. Chame 'Ler Contrato (Arquivo PDF ou XLSX)' para obter o texto completo.\n"
        ...
        "3. Se alguma regra não estiver explícita, aplique boas práticas do setor como default.\n"
        f"4. Monte o JSON completo (veja formato abaixo) para {d} dias de cardápio.\n"
        "5. Chame 'Salvar Regras Extraídas do Contrato' com o JSON.\n"
        "6. Confirme o salvamento com 'Recuperar Regras do Contrato'.\n"
        "7. Envie relatório ao Coordenador via 'Enviar Relatório ao Coordenador'.\n\n"
